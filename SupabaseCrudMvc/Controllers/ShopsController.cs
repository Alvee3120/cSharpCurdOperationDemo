...
namespace SupabaseCrudMvc.Controllers
{
    public class ShopsController : Controller
    {
        ...
        public ShopsController(SupabaseCrudMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ShopId,Name,Location,ContactEmail")] Shop shop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShopId,Name,Location,ContactEmail")] Shop shop)
        {
            if (id != shop.ShopId)
            {
                return NotFound();
